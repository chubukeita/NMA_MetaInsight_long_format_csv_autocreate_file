...
If you want to specify the NMA group name directly, enter the name of each group from "ArmList" in column P of "SortSheet" to specify the groups in a list format from "arm" of "Input Form".
