...
## initialization
Please unzip the Zip file (this zip file contains the macro-enabled book (NMA_MetaInsight_long_format_csv_autocreate_file.xlsm)) and activate the macro-enabled book before use. And please enable "Selenium".
